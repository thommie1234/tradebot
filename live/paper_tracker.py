    ...
    def on_signal(self, symbol: str, direction: str | None, confidence: float,
        ...
        if self.logger:
            ...
            try:
                ...
                try:
                    import numpy as _np
                    _mt5 = getattr(self, '_mt5', None)
                    if _mt5:
                        _tf_map = {'M5': 16388, 'M15': 16385, 'M30': 16386, 'H1': 16385, 'H4': 16388}
                        _bars = _mt5.copy_rates_from_pos(symbol, _tf_map.get(timeframe, 16386), 0, 30)
                ...
                self.logger.log('INFO', 'PaperTracker', 'TRADE_META',
