...
class SovereignMLFilter:
    ...
    def __init__(self, symbol, logger, model_dir=None):
        self.symbol = symbol
        self.logger = logger
        self.model = None  # xgb.Booster
        self._model_dir = model_dir  # None = use cfg.MODEL_DIR
    ...
    def model_path(self) -> str:
        base = self._model_dir or cfg.MODEL_DIR
        return os.path.join(base, f"{self.symbol}.json")
    ...
    def train_model(self) -> bool:
        ...
        feat = feat.with_columns([
            ...
            pl.lit(float(optuna_cfg.get("fee_bps", 3.0))).alias("fee_bps"),
