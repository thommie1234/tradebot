...
SECTOR_MAP = {
    # Crypto
    "AAVUSD": "crypto", "AAVEUSD": "crypto", "ADAUSD": "crypto", "ALGUSD": "crypto",
    "AVAUSD": "crypto", "BARUSD": "crypto", "BCHUSD": "crypto",
    "BNBUSD": "crypto", "BTCUSD": "crypto", "DASHUSD": "crypto",
    "DOGEUSD": "crypto", "DOTUSD": "crypto", "ETCUSD": "crypto", "XDGUSD": "crypto",
...
class PositionSizingEngine:
    ...
    def calculate_lot_size(self, symbol, account_equity, risk_pct, sl_distance,
        ...
        # Clamp to min_lot but NOT to max_lot — order_router handles
